...
public class Model extends GameObject{
    //all vertices in this model
    private Vector3[] vertices;
    //all vertices in this model after transformation
    private Vector3[] transformedVertices;
    //  all the faces in this model
    private Face[] faces;
    // coordinate of the center of each face
    private Vector3[] faceCenters;
    //  coordinate of the center of each face after transformation
    ...
    public Model(){
        super("empty", new Vector3(), new Vector3(), new Vector3(1, 1, 1));
...
//                        }
//                        points.add(Integer.parseInt(substr) - 1);
//                        line = line.substring(0,len);

//                        String substr = line.substring(0, Math.max(line.indexOf(" "),line.length()));
...
//                        }
    ...
    public void setRotation(Vector3 newRotation) {
        ...
        this.setTransformRotation(getRotation());
    }
    ...
    public void setTransformRotation(Quaternion newRotation) {
        super.setRotation(newRotation);
        // Rotate vertices
        for (int i = 0; i < vertices.length; i++) {
            // Rotate
